...
int prescaler = 176;		// Sample Rate: 20kHz; Distinguish: 19.5Hz
int calibrated = 0;
...
// Enable ADC1_Channelx
static void ADC1_Mode_Config(int ADC1_Channelx) 
{ 
...
void ADC1_Init(int ADC1_Channelx)
{
	...
	ADC1_TIM2_Config();
	ADC1_DMA1_Config();
	ADC1_Mode_Config(ADC1_Channelx);
}
